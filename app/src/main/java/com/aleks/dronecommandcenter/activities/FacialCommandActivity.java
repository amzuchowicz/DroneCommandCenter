...
import com.aleks.dronecommandcenter.customspinner.CustomAdapter;
import com.aleks.dronecommandcenter.customspinner.CustomSpinner;
import com.aleks.dronecommandcenter.customspinner.SpinnerModel;
import com.aleks.dronecommandcenter.dateget.EngineConnector;
import com.aleks.dronecommandcenter.dateget.EngineInterface;
...
@SuppressLint("NewApi")
public class FacialCommandActivity extends AppCompatActivity implements EngineInterface {
		...
		btStartTrainning.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if(!engineConnector.isConnected)
					Toast.makeText(FacialCommandActivity.this,"You need to connect to your headset.",Toast.LENGTH_SHORT).show();
				else{
